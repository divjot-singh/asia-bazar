...
class CardUtils {
  static String validateCVV(String value) {
    ...
    if (value.length < 3 || value.length > 4) {
      return L10n().getStr('payments.cvvNumber.error');
    }
    return null;
  }
  ...
  static String validateDate(String value) {
    ...
    if ((month < 1) || (month > 12)) {
      ...
      return L10n().getStr('payments.invalidMonth');
    }
    ...
    if ((fourDigitsYear < 1) || (fourDigitsYear > 2099)) {
      ...
      return L10n().getStr('payments.invalidYear');
    }

    if (!hasDateExpired(month, year)) {
      return L10n().getStr('payments.cardExpired');
    }
    return null;
  }
  ...
  static getCardIconFromCardType(String type, {double height}) {
    String img = "";
    Icon icon;
  ...
  static String validateCardNum(String input) {
    ...
    if (input.length < 8) {
      return L10n().getStr('payments.cardNumber.error');
    }
